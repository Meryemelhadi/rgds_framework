...
{records}
{record}
		{ url:"{field:image:"url"}" }{if: not record.is_last},{/if}
{/record}
{/records}
...
<tr>
	<td colspan="2" valign="top"align="right">
		<table>
			<tr>
				<td align="right" class="button">{button:add}</td>
...
<div id="traceW" style="height:300px;overflow:scroll">trace:</div>
<script>mytrace("trace started");</script>
