...
<input type="radio" value="keep" class="radio_file  form-control" 
	...
	<span class="radio_file  form-control">{$s_k}</span>

<input  type="radio" value="replace" class="radio_file  form-control" 
	id="{$F_}_choice_replace" name="{$F_}_choice" 
	onclick="Nx_onReplaceFile($('{$F_}_choice_file'),$('{$F_}_choice_file'))"/>
	<span class="radio_file  form-control">{$s_r}</span>

<input type="radio" value="delete"	class="radio_file  form-control" 
	id="{$F_}_choice_delete" name="{$F_}_choice" 
	onclick="Nx_onDeleteFile($('{$F_}_choice_file'),$('{$F_}_choice_file'))">
	<span class="radio_file  form-control"/>{$s_d}</span>
<!-- input type="radio" value="db"	class="radio_file  form-control" 
	id="file_choice_db" name="file_choice" 
	onclick="Nx_onDeleteFile(file_choice_file,file_choice_file)">
	<span class="radio_file  form-control">{$s_i}</span -->
<br>	
