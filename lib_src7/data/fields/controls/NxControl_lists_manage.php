...
EOH;
		...
		return <<<EOH
{$script}<table class="control_lists control_lists_manage">
<tr>
...
<input type="button" style="width:50px"  onclick="return manage_list_select('{$fname}',event)" value="<--" title="add to selection"><br/>
<input type="button"  style="width:50px" onclick="return manage_list_remove('{$fname}',event)" value="-->" title="remove from selection">
</td>
<td style="vertical-align:top">
<select class="select" {$isMultiple} 
