...
//			$option="<option value=\"$k\">".htmlentities($listArray[$k])."</option>";
		...
		$placeholder = _('Recherche option');
...
<tr>
	...
	<td style="vertical-align:top">$others<br/>
		<div>
			<input type="text" placeholder="$placeholder" class="filter_text form-control input-sm" style="width:200px;" onKeyUp="return manage_list_filter('filter_val_{$fname}','{$fname}',event,false)" onchange="return manage_list_filter('filter_val_{$fname}','{$fname}',event,true)" name="filter_val_{$fname}" id="filter_val_{$fname}">
		</div>
	</td>
</tr>
<tr>
<td style="vertical-align:top">
<select class="select select_list form-control" {$isMultiple} 
...
<input type="button" class="button_select_list" onclick="return manage_list_select('{$fname}',event)" value="<--" title="add to selection"><br/>
<input type="button" class="button_select_list" onclick="return manage_list_remove('{$fname}',event)" value="-->" title="remove from selection">
</td>
<td style="vertical-align:top">
<select class="select select_list form-control" {$isMultiple} 
