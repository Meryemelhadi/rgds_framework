...
*/
	...
	var $hasTop = true;			/// support mssql/access SELECT TOP 10 * FROM TABLE
	...
	var $_transOK = null;
	var $_connectionID	= true;	/// The returned link identifier whenever a successful database connection is made.	
	var $_errorMsg = true;		/// A variable which was used to keep the returned last error message.  The value will
								/// then returned by the errorMsg() function	
	var $_errorCode = true;	/// Last error code, not guaranteed to be used - only by oci8					
	var $_queryID = true;		/// This variable keeps the last created result link identifier
